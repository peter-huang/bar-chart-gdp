# Bar Chart United States GDP

A React-D3.js bar chart application completed for the freecodecamp data visualization curriculum. I can use any mix of HTML, JavaScript, CSS, Bootstrap, SASS, React, Redux, D3.js, and jQuery to complete this project.
